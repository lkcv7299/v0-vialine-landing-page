...
export const products: Product[] = [
  ...
  // PESCADOR (suplex)
  {
    ...
    price: 46,
    image: "/productos/mujer/pescador-realce-azulino.webp",
    category: "pescador",
    fabric: "suplex",
    colors: [
      {
      ...
      },
      {
        ...
        slug: "charcol",
        hex: "#5A5A5A",
        image: "/productos/mujer/pescador-realce-charcol.webp",
      },
      {
        name: "Negro",
        slug: "negro",
        hex: "#000000",
        image: "/productos/mujer/pescador-realce-negro.webp",
      },
      {
        name: "Rojo",
        slug: "rojo",
        hex: "#D22B2B",
        image: "/productos/mujer/pescador-realce-rojo.webp",
      },
    ],
    sizes: ["S", "M", "L", "XL"],
    audience: "mujer",
    ...
    attributes: {
      material: "Suplex liso",
      detalles: ["Pretina ancha para mejor comprensión en el abdomen", "Ajuste ideal", "Realce en la parte trasera"],
      beneficios: [
        "Se adapta al cuerpo como una segunda piel, ayudándote a reducir la vibración muscular en tus rutinas",
  ...
  },
  {
    ...
    price: 46,
    image: "/productos/mujer/pescador-dynamic-azulino.webp",
    category: "pescador",
    fabric: "suplex",
    colors: [
      {
      ...
      },
      {
        ...
        slug: "charcol",
        hex: "#5A5A5A",
        image: "/productos/mujer/pescador-dynamic-charcol.webp",
      },
      {
        name: "Negro",
        slug: "negro",
        hex: "#000000",
        image: "/productos/mujer/pescador-dynamic-negro.webp",
      },
      {
        name: "Rojo",
        slug: "rojo",
        hex: "#D22B2B",
        image: "/productos/mujer/pescador-dynamic-rojo.webp",
      },
    ],
    sizes: ["S", "M", "L"],
    audience: "mujer",
