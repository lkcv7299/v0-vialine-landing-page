/**
 * Actualiza solo cafarena-nina y panty-nina que les falta galería
 */
const fs = require('fs');
...
const PRODUCTS = [
  { slug: 'cafarena-nina', gender: 'nina', category: 'cafarenas' },
  { slug: 'panty-nina', gender: 'nina', category: 'pantys' }
];
...
function createBackup() {
  ...
  const backupPath = path.join(BACKUP_DIR, `products-remaining-${timestamp}.ts`);
...
console.log('🔨 Actualizando galerías restantes...\n');
...
console.log('✅ Galerías actualizadas correctamente');
