...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const categoriasPages: MetadataRoute.Sitemap = categoriasMujer.map(cat => ({
  ...
  const categoriasNinaPages: MetadataRoute.Sitemap = categoriasNina.map(cat => ({
  ...
  // Productos individuales - CORREGIDO
