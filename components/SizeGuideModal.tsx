...
type ProductCategory = "leggings" | "bikers" | "shorts" | "tops" | "bodysuits" | "camisetas" | "enterizos" | "pescador" | "torero" | "cafarenas" | "pantys"
...
function getSizeGuideType(category: ProductCategory): "bottoms" | "tops" | "all" {
  const bottomsCategories: ProductCategory[] = ["leggings", "bikers", "shorts", "pescador", "torero", "cafarenas", "pantys"]
