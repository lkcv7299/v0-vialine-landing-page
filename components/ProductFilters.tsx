...
export default function ProductFilters({ totalProducts, filteredCount }: ProductFiltersProps) {
  ...
  return (
    <aside className="h-fit sticky top-20">
      {/* Header con toggle mobile */}
      <div 
        className="lg:hidden flex items-center justify-between p-4 bg-white rounded-2xl border border-neutral-200 mb-4 cursor-pointer"
      ...
      <div className={`${isOpen ? "block" : "hidden"} lg:block rounded-2xl border border-neutral-200 bg-white overflow-hidden`}>
        {/* Header desktop */}
        <div className="hidden lg:flex items-center justify-between p-4 border-b border-neutral-200">
          <div className="flex items-center gap-2">
            <Filter className="w-5 h-5 text-rose-600" />
            <span className="font-semibold text-neutral-900">Filtros</span>
            {activeFiltersCount > 0 && (
